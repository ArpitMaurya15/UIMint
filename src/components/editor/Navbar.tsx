    ...
    <div className={`
      ...
      <div className={`${!isMobile ? 'order-2' : 'order-1'}`}>
        ...
        <Button
          ...
          className="w-full"
        >
          <a href='https://github.com/ArpitMaurya15/UIMint' target="_blank" rel="noopener noreferrer" className='inline-flex gap-2 w-full grid-cols-2'>
            <Github />
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className='text-sm text-muted-foreground leading-relaxed'>
              UIMint is a simple offline tool.
            </p>
            <p className='text-sm text-muted-foreground leading-relaxed'>
    ...
    <div className="sticky top-0 z-50 bg-background/80 backdrop-blur-lg border-b">
      <div className="flex items-center justify-between px-4 h-16 lg:mx-40">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold text-primary">UIMint</h1>
            <a
              href=""
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="flex items-center gap-2">
          <a href='https://github.com/ArpitMaurya15/UIMint' target="_blank" rel="noopener noreferrer"
          >
            <Button
              variant="outline"
